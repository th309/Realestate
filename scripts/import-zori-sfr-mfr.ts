#!/usr/bin/env npx tsx
/**
 * Import ZORI Single Family and Multifamily datasets to zillow_metro
 */
...
const ZORI_DATASETS: DatasetConfig[] = [
  {
    id: 'zori-sfr-metro',
...
async function main() {
  ...
  console.log('ZORI SFR & MFR IMPORT');
  console.log('='.repeat(60));
  ...
  for (const dataset of ZORI_DATASETS) {
