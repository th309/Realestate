...
export const ALL_ZILLOW_DATASETS: ZillowDatasetConfig[] = [
  ...
  // Retired 2026-06-16: Zillow renamed/deprecated these metro files (~Dec 2025);
  // configured URLs 404 and Zillow's site blocks auto-discovery. Non-score map
  // metrics. days-to-close was redundant with days-to-pending (kept above).
  // Removed: new-con-price, affordable-price, list-price, sale-to-list, days-to-close.
];

/**
 * Filter datasets by geography level.
 */
export function getDatasetsByGeography(
  geography: ZillowGeography,
): ZillowDatasetConfig[] {
