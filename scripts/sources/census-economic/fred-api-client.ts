...
const METRO_CBSA_TO_FRED_EMPLOYMENT: Record<string, string> = {
  "35620": "SMU36935620000000001",
  "31080": "SMU06310800000000001",
  "16980": "SMU17169800000000001",
  "19100": "SMU48191000000000001",
  "26420": "SMU48264200000000001",
  "47900": "SMU11479000000000001",
  "33100": "SMU12331000000000001",
  "37980": "SMU42379800000000001",
  "12060": "SMU13120600000000001",
  "14460": "SMU25144600000000001",
  "38060": "SMU04380600000000001",
  "41860": "SMU06418600000000001",
  "40140": "SMU06401400000000001",
  "19820": "SMU26198200000000001",
  "42660": "SMU53426600000000001",
  "33460": "SMU27334600000000001",
  "41740": "SMU06417400000000001",
  "45300": "SMU12453000000000001",
  "19740": "SMU08197400000000001",
  "41180": "SMU29411800000000001",
  "12580": "SMU24125800000000001",
  "36740": "SMU12367400000000001",
  "16740": "SMU37167400000000001",
  "41700": "SMU48417000000000001",
...
export async function fetchFredNationalUnemployment(
  startYear: number,
...
export async function fetchFredNationalEmployment(
  startYear: number,
): Promise<Record<string, unknown>[]> {
    ...
    .map((obs) => {
      ...
      return {
        ...
        total_nonfarm_employment:
          rawEmployment !== null ? Math.round(rawEmployment * 1000) : null,
      };
    });
}
...
export async function fetchFredStateUnemployment(
  startYear: number,
): Promise<Record<string, unknown>[]> {
  ...
  for (const [fips, seriesId] of Object.entries(
    STATE_FIPS_TO_FRED_UNEMPLOYMENT,
  )) {
...
export async function fetchFredStateEmployment(
  startYear: number,
): Promise<Record<string, unknown>[]> {
...
export async function fetchFredMetroUnemployment(
  startYear: number,
): Promise<Record<string, unknown>[]> {
  ...
  for (const [cbsa, seriesId] of Object.entries(
    METRO_CBSA_TO_FRED_UNEMPLOYMENT,
  )) {
    const observations = await fetchFredSeries(seriesId, startDate);
    for (const obs of observations) {
      if (obs.value !== ".") {
...
export async function fetchFredMetroEmployment(
  startYear: number,
): Promise<Record<string, unknown>[]> {
