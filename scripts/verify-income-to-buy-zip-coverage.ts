...
async function main() {
  console.log(
    "Income-to-buy zip coverage: realtor_zip vs calculated_metrics\n",
  );
  ...
  if (!match && c < r) {
    console.log(
      "  To fix: npx tsx scripts/calculations/calculated-metrics-runner.ts (or your standard refresh workflow)\n",
    );
  }
