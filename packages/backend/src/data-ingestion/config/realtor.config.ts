...
export const REALTOR_DATASETS: RealtorDatasetConfig[] = [
  {
    id: 'realtor-national',
    downloadUrl:
      'https://econdata.s3-us-west-2.amazonaws.com/Reports/Core/RDC_Inventory_Core_Metrics_Country.csv',
  ...
  },
  {
    id: 'realtor-state',
    downloadUrl:
      'https://econdata.s3-us-west-2.amazonaws.com/Reports/Core/RDC_Inventory_Core_Metrics_State.csv',
  ...
  },
  {
    ...
    hotnessUrl:
      'https://econdata.s3-us-west-2.amazonaws.com/Reports/Hotness/RDC_Inventory_Hotness_Metrics_Metro.csv',
  ...
  },
  {
    ...
    hotnessUrl:
      'https://econdata.s3-us-west-2.amazonaws.com/Reports/Hotness/RDC_Inventory_Hotness_Metrics_County.csv',
  ...
  },
  {
    ...
    hotnessUrl:
      'https://econdata.s3-us-west-2.amazonaws.com/Reports/Hotness/RDC_Inventory_Hotness_Metrics_Zip.csv',
