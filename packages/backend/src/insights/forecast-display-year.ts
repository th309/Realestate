/**
 * Display year for forecast content, derived from the score period date (not
 * generation time — the score period lags generation by several weeks, so
 * using generation time drifts the displayed year around month boundaries).
