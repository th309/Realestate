 ...
 *
 * Defines the OpenAI-compatible tool-use schema for the research agent.
 * Each tool maps to a backend data-fetching operation that the
 * AI research agent can invoke during the tool-use loop.
 */

import OpenAI from 'openai';

// Re-export the tool type for consumers
export type ResearchTool = OpenAI.ChatCompletionTool;
