...
export function buildNarrativeTemplateVars(
  ...
  return {
    ...
    // Market intelligence briefing context (optional enhancement)
    // When a briefing exists, these vars let prompt templates include stance,
    // risk, and news context for narrative consistency with intelligence.
    // When no briefing exists, all values are null → conditional blocks skip.
    ...buildBriefingTemplateVars(briefingContext),
  };
}
