...
// Feature/content icons — used in nav dropdowns, page sections, data displays.
...
export const ScreenerIcon = ({
  ...
  <svg
    ...
    className={className}
  >
    <path d="M3 5h2V3H3v2zm0 8h2v-2H3v2zm4 8h2v-2H7v2zM3 9h2V7H3v2zm10-6h-2v2h2V3zm6 0v2h2V3h-2zM5 21v-2H3v2h2zm-2-8h2v-2H3v2zm8 8h2v-2h-2v2zm4-8h2v-2h-2v2zm0 8h2v-2h-2v2zm4-8h2v-2h-2v2zm0-10v2h2V3h-2zm-4 4h2V5h-2v2zm-4 0h2V5h-2v2zM7 9h2V7H7v2zm0-6v2h2V3H7zm-4 6h2V7H3v2z" />
  </svg>
);
