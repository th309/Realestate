...
A score of 18 means the model expects Austin to significantly underperform the typical Texas market over roughly the next three years. The score is built on the market's demand signal: home-value momentum, days on market, and the share of listings cutting price. Right now those readings are weak: homes are sitting, sellers are cutting prices, and momentum has stalled.
