...
The PropertyIQ Score is a 0-100 composite index that measures current market health across price trends, inventory levels, demand signals, affordability, and economic fundamentals. It does not care whether a market is a college town or a coastal city. It reads the data and scores what the data says.
...
Active inventory of 3,034 listings against a moderate demand profile produces weak absorption metrics. The listing price of $299,958 reflects accessibility, but price accessibility without demand strength is a yield trap. The score of 44 places Baton Rouge in buyer's market territory where sellers are competing for a limited pool of qualified buyers.
