...
The PropertyIQ Score is a forward-looking prediction of how a market is likely to perform over roughly the next three years relative to its state, on a 0-to-100 monthly scale built from the market's demand signal: home-value momentum, days on market, and price-cut share. A score of 50 represents the Michigan state average. At 83, the model expects Ann Arbor to outperform the typical Michigan market, placing it among the stronger mid-sized markets in the Midwest.
