...
Raleigh is in a similar position to [Charlotte](/markets/charlotte-concord-gastonia-nc-sc) (scored 39): a high-growth metro where rapid population and job inflows drove home prices to levels the local income base is straining to support. Until inventory is absorbed or prices adjust further, the score points to a market the model expects to underperform its state in the near term — not distressed, but with a demand signal not yet strong enough to lift it above its state average.
