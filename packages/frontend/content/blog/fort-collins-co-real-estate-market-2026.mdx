...
A score of 35 does not indicate Fort Collins is in economic distress. Unemployment is among the lowest in Colorado. The economy is stable. The score means the model expects Fort Collins to underperform the typical Colorado market over the next few years, reading a soft demand signal driven by price levels relative to income, not by job losses or population outflows.
