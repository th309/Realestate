...
The PropertyIQ Score is a 0 to 100 index that predicts how a market is positioned to perform over roughly the next three years relative to its state. A score of 50 represents the state average. Scores above 70 indicate expected outperformance versus the state. Provo's 67 as of February 28, 2026 puts it above its state average but short of the tier that PropertyIQ identifies as high-conviction.
...
Provo's movement from 47 in December 2025 to 67 in February 2026 reflects a strengthening demand signal -- improving momentum and absorption -- that now points to outperformance versus its state. The correction in scores during the summer and fall of 2025 was likely driven by affordability pressure and inventory normalization. The recovery in late 2025 and early 2026 suggests some rebalancing has occurred.
...
The PropertyIQ Score is a 0 to 100 index updated monthly. It is built from a market's demand signal -- home-value momentum (Zillow), median days on market, and the share of listings cutting price (Realtor.com) -- across more than 400 U.S. metros, and predicts performance over roughly the next three years relative to the market's state.

A score of 50 represents the state average. Provo's score of 67 as of February 28, 2026 places the metro above its state average -- expected to modestly outperform the typical Utah market -- with a positive 6-month trend. The primary factors limiting a higher score are the elevated overvaluation estimate and the affordability gap between median income and median home prices.
