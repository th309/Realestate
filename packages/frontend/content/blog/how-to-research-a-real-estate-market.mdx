...
date: "2026-04-11"
description: "A practical five-step framework for researching a real estate market before investing. Covers jobs, supply-demand balance, affordability, price trajectory, and rental demand. Explains how the PropertyIQ Score aggregates all five into one index."
keywords:
...
This guide gives you a five-step framework for researching a real estate market the way an analyst would, using the data signals that actually predict market performance. It also explains why PropertyIQ aggregates all five into a single market score updated monthly for every U.S. metro.
...
The PropertyIQ Score aggregates these five dimensions into a single 0-100 index, updated monthly, for every U.S. metro, county, and ZIP code.

**What is in the score:**
- Supply-demand signals: pending ratio, days on market, sale-to-list ratio
- Price momentum: year-over-year appreciation, 5-year trajectory
- Affordability and valuation: overvaluation vs fundamental value, income alignment
- Economic health: unemployment rate, job growth direction

**What the score means:**
- Above 80: Market conditions are strong. Low supply, high demand, reasonable valuation. Worth deeper research.
- 60-80: Solid conditions with identifiable trade-offs. Understand what is pulling the score up or down.
- 40-60: Mixed conditions. Not a buy or avoid signal. Strategy-dependent.
- Below 40: Meaningful headwinds. High inventory, weak demand, overvaluation, or some combination.

The score does not tell you which property to buy. It tells you whether the market conditions support the investment thesis before you spend time on property-level analysis.
...
The five-step framework in this guide is what the score is built from. Working through each step manually for your target market gives you the understanding to evaluate any score in context, not just accept a number.
...
<CTABlock
  headline="Check Your Target Market"
  body="Get the PropertyIQ Score for any U.S. metro, county, or ZIP. Free accounts show current scores for 400+ markets."
  ctaText="Search Your Market"
