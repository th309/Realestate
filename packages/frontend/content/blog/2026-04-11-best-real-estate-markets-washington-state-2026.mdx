...
The PropertyIQ Score runs from 0 to 100, with 50 representing the national average for metro areas of comparable size. Washington State's top markets score well above that benchmark, driven by persistent supply constraints, strong employment bases, and demand that has remained durable through the 2024 to 2025 rate environment.
