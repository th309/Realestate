...
The hotness score is 81.3. The supply score is 85.3. The demand score is 77.3. All three components score above 75, which means no single weak leg is dragging down the composite. A 96 means the model expects Allentown to substantially outperform the typical Pennsylvania market over the next few years, on the strength of its demand signal.
