...
Boston is a supply-constrained, high-income, high-demand market. The 96 score means the model expects Boston to strongly outperform the typical Massachusetts market over the next few years -- though that is a relative-performance signal, not a cash flow thesis. At a $799K median, cash flow is not accessible by conventional yield math.
