...
The PropertyIQ Score is updated monthly using Zillow and Realtor.com data across 400+ U.S. markets. Every metro, county, and ZIP code gets a score from 0 to 100. It is a forward-looking prediction of how a market is likely to perform over roughly the next three years relative to its state, built from the market's demand signal: home-value momentum, days on market, and price-cut share.
