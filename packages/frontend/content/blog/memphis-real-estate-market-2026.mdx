...
PropertyIQ scores [Memphis a 50 out of 100](/markets/memphis-tn-ms-ar) as of February 28, 2026 — exactly at its state average, meaning the model expects it to perform about in line with the typical Tennessee market.
