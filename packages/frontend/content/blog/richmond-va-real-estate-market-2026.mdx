...
A score of 93 means the model expects Richmond to outperform the typical Virginia market over the next few years, driven by a strong demand signal. The overvaluation figure reflects affordability risk at the current price level. Both are real. Read them together.
