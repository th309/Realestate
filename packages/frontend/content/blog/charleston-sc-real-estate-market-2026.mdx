...
**Score crossing 50 and sustaining it.** A PropertyIQ Score above 50 signals that the model expects Charleston to outperform the typical South Carolina market. Until that crossing is sustained for two or more consecutive months, the recovery remains tentative.
...
**For homebuyers:** Charleston is still below the state average at 40. That means buyer conditions are more favorable than the market's coastal reputation might suggest. You have more time, more choices, and more negotiating leverage than during the 2021 to 2023 period. If your lifestyle and employment anchor you to the Charleston area, the current market is more favorable for buyers than any point in the past four years.
...
A score of 50 represents the state average — the typical market in that state. Scores above it signal a market the model expects to outperform its state.
