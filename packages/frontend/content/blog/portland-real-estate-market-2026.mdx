...
A score of 81 tells you the model expects Portland to outperform the typical Oregon market over the next few years, on the strength of a demand signal where supply is tight and what listings exist are going under contract at a reasonable rate. The depreciation figures, the overvaluation metric, and the negative Zillow forecast tell you about price trajectory and affordability. These are different questions.
