...
states: ["AL", "IN", "MI", "MO", "NY", "OH", "PA", "TN"]
image: "/images/blog/highest-rent-to-price-ratio-cities-2026.png"
---
...
This post ranks 10 U.S. cities by monthly rent-to-price ratio using PropertyIQ data updated through February 2026. Every market figure in this analysis is sourced from the PropertyIQ dataset, which tracks 900+ metros, 3,000+ counties, and 29,000+ ZIP codes and is updated monthly using Zillow, Census, Realtor.com, and economic data.
...
<CTABlock
  heading="See Full Rent-to-Price Data for Any Market"
