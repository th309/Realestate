...
Waco is a market in recovery. A score of 36 means the model expects Waco to underperform the typical Texas market over the next few years, but the 15-point gain in three months signals that the recovery is real. The volume surge of 40.2% year over year is the most important data point in the Waco report: buyers have returned to the market at meaningful rates despite slow DOM and price cuts.
