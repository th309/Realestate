...
export const COMPARISONS: ComparisonData[] = [
  ...
  },
  {
    ...
    summary:
      "PropertyIQ covers more than four times as many metros as Mashvisor, updates data monthly rather than quarterly, and offers a free tier plus a Pro plan at {{PRO_PRICE}}/month compared to Mashvisor's $99/month starting price. Mashvisor specializes in short-term rental analytics with Airbnb data, making it a better fit for vacation-rental investors. For broad market analysis with AI-powered scoring at a fraction of the cost, PropertyIQ is the clear winner.",
    faqs: [
      {
        question:
