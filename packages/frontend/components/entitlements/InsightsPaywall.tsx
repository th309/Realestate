    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-on-surface-variant mb-3">
          Hard data meets soft signals. Get AI analysis that factors in news,
          trends, and local context for deeper market understanding.
        </p>
        <Link
    ...
    >
      ...
      <div className="bg-gradient-to-br from-primary/5 via-surface-container to-tertiary/5 px-6 pt-6 pb-4">
        ...
        <p className="text-sm text-on-surface-variant">
          ...
          hard data with news and local signals for analysis that captures what
          spreadsheets miss.
        </p>
      </div>
      ...
      <div className="px-6 pb-4">
        <div className="bg-surface rounded-xl p-4 border border-dashed border-outline-variant/50">
          <p className="text-xs text-on-surface-variant italic leading-relaxed">
            "Austin's market shows cooling demand with inventory up 18% YoY, but
            recent tech sector expansions and favorable zoning changes signal a
