...
const STATE_DATA: Record<
  string,
  { name: string; price: string; change: number; x: number; y: number }
> = {
  ...
  return (
    <div className="relative w-full h-full min-h-[320px] bg-surface-container rounded-xl overflow-hidden">
      ...
      <svg
        ...
        role="img"
        aria-label="Interactive market map demo"
      >
        <defs>
          <linearGradient
            id="demoMapGradient"
          ...
          >
            <stop
              offset="0%"
              className="[stop-color:var(--md-primary)]"
              stopOpacity="0.05"
            />
            <stop
              offset="100%"
              className="[stop-color:var(--md-tertiary)]"
              stopOpacity="0.05"
            />
          </linearGradient>
        </defs>
            ...
            className={`transition-all cursor-pointer ${
              selectedState === "CA"
                ...
                : hoveredState === "CA"
                  ...
                  : "fill-tertiary/40 stroke-surface"
            }`}
            strokeWidth="1"
          ...
          <path
            ...
            className={`transition-all cursor-pointer ${
              selectedState === "WA"
                ...
                : hoveredState === "WA"
                  ? "fill-primary/40 stroke-primary"
                  : "fill-secondary/40 stroke-surface"
            }`}
            strokeWidth="1"
          ...
          <path
            ...
            className={`transition-all cursor-pointer ${
              selectedState === "CO"
                ...
                : hoveredState === "CO"
                  ? "fill-primary/40 stroke-primary"
                  : "fill-primary/40 stroke-surface"
            }`}
            strokeWidth="1"
          ...
          <path
            ...
            className={`transition-all cursor-pointer ${
              selectedState === "TX"
                ...
                : hoveredState === "TX"
                  ? "fill-primary/40 stroke-primary"
                  : "fill-secondary/50 stroke-surface"
            }`}
            strokeWidth="1"
          ...
          <path
            ...
            className={`transition-all cursor-pointer ${
              selectedState === "GA"
                ...
                : hoveredState === "GA"
                  ? "fill-primary/40 stroke-primary"
                  : "fill-primary/50 stroke-surface"
            }`}
            strokeWidth="1"
          ...
          <path
            ...
            className={`transition-all cursor-pointer ${
              selectedState === "FL"
                ...
                : hoveredState === "FL"
                  ? "fill-primary/40 stroke-primary"
                  : "fill-tertiary/50 stroke-surface"
            }`}
            strokeWidth="1"
      ...
      <div className="absolute bottom-3 left-3 right-3 bg-surface/95 rounded-lg p-3 shadow-lg backdrop-blur-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div
              className={`text-xs font-medium ${selectedData.change > 0 ? "text-green-600" : "text-red-600"}`}
            >
              {selectedData.change > 0 ? "+" : ""}
              {selectedData.change}% YoY
            </div>
          </div>
        </div>
        <Link
