  ...
  return (
    ...
    >
      ...
      >
        <h2
          id="cta-heading"
          className="text-3xl md:text-4xl font-bold text-[#1A237E] mb-5 tracking-tight font-[family-name:var(--font-source-serif)]"
        >
          Stop guessing. Start investing with data.
        </h2>
        <p className="text-lg text-[#3949AB] mb-10 leading-relaxed">
