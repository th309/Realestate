  ...
  return (
    <svg viewBox="0 0 200 120" className="w-full h-full" aria-hidden="true">
      ...
      <g className="opacity-80">
        ...
        <path
          d="M120,50 L155,60 L145,95 L130,85 Z"
          className="fill-tertiary/50"
        />
      </g>
      ...
      <circle
        ...
        cy="45"
        r="4"
        className="fill-tertiary animate-pulse"
    ...
    <div className="w-full h-full p-3 flex flex-col gap-2">
      ...
      {[
        ...
        >
          ...
          <div
            className="h-2 rounded bg-on-surface/10"
            style={{ width: item.w }}
          />
        </div>
      ))}
...
export function FeatureCarousel() {
  ...
  return (
    <div className="relative w-full max-w-xl">
      ...
      <div
        className="absolute -bottom-2 -left-3 bg-surface rounded-xl p-2.5 shadow-lg border border-outline-variant/20 animate-bounce-slow"
        style={{ animationDelay: "0.5s" }}
      >
        <div className="flex items-center gap-2">
          <svg
