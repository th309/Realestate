...
type Testimonial = {
  ...
  name: string;
  role: string;
  /** Initials shown in the avatar circle. Decorative — the name sits beside it. */
  initials: string;
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        {TESTIMONIALS.map((testimonial) => (
          <figure
            ...
            className="flex flex-col gap-6 rounded-xl border border-outline-variant bg-surface-container-low p-8"
          >
            {testimonial.tag ? (
            ...
            <figcaption className="mt-auto flex items-center gap-3">
              <span
                aria-hidden="true"
                className="grid h-11 w-11 flex-none place-items-center rounded-full bg-primary-container text-[14.5px] font-bold text-on-primary-container"
              >
