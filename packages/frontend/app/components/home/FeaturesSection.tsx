...
function FeatureCard({
  ...
  return (
    ...
    >
      <div
        className="w-12 h-12 rounded-xl bg-primary-container flex items-center justify-center mb-4 text-on-primary-container"
        aria-hidden="true"
      >
        {icon}
      </div>
      <h3 className="feature-title text-lg font-semibold text-on-surface mb-2">
        {title}
      </h3>
...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Visualize home values, rental prices, and market trends across metros. Drill down from state to metro, county, and ZIP code to find the best markets for buying or investing.",
  },
  {
    icon: <Icons.Report />,
    title: "AI-Generated Market Reports",
    description:
      "Generate professional market analysis reports for clients instantly. Perfect for real estate agents presenting to buyers or investors sharing with partners.",
  },
  {
    icon: <Icons.Data />,
  ...
  },
  {
    ...
    description:
      "Machine learning models predict home appreciation, rental demand, and market cycles. Know when to buy, sell, or hold investment properties.",
  },
  {
    icon: <Icons.Shield />,
    title: "Investment Risk Analysis",
    description:
      "Evaluate downside scenarios for rental properties with vacancy risk, economic sensitivity, and market volatility metrics before you invest.",
  },
];
    ...
    >
      ...
      <header className="text-center max-w-xl mx-auto mb-10">
        ...
        <p className="text-on-surface-variant">
          From market scores for first-time buyers to ROI analysis for seasoned
          investors, PropertyIQ delivers institutional-grade real estate
          intelligence.
        </p>
      </header>
