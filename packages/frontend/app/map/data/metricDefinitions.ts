...
export const METRIC_DEFINITIONS: Record<string, MetricDefinition> = {
  ...
  unemployment_rate: {
    ...
    dataSource: 'Bureau of Labor Statistics via FRED',
    updateFrequency: 'Monthly',
  },
  job_growth: {
    id: 'job_growth',
    name: 'Job Growth',
    description: 'Year-over-year percentage change in total employment. Positive job growth attracts population and housing demand.',
  ...
  gdp_growth: {
    ...
    dataSource: 'Bureau of Economic Analysis via FRED',
    updateFrequency: 'Quarterly',
  },
  cost_of_living: {
    id: 'cost_of_living',
    name: 'Cost of Living Index',
    description: 'Index comparing local prices to the national average (100). Values above 100 indicate higher than average costs.',
    dataSource: 'Bureau of Economic Analysis / Census',
    updateFrequency: 'Annual',
  ...
  long_term_growth: {
    ...
    description: 'Composite score predicting long-term home value appreciation potential based on economic, demographic, and market factors.',
    formula: 'Weighted combination of job growth, population growth, income growth, and supply constraints',
    dataSource: 'Calculated',
    updateFrequency: 'Monthly',
    notes: 'Score from 0-100; higher indicates stronger growth potential',
  },
  market_health: {
    id: 'market_health',
    name: 'Market Health Score',
    description: 'Overall health of the real estate market based on supply/demand balance, price stability, and market velocity.',
    formula: 'Composite of DOM, inventory levels, price cut %, and pending ratio',
    dataSource: 'Zillow',
    updateFrequency: 'Monthly',
    notes: 'Score from 0-100; higher indicates healthier market conditions',
  },
  investment_score: {
    id: 'investment_score',
    name: 'Investment Score',
    description: 'Composite score rating the attractiveness of an area for real estate investment based on yields, growth, and risk factors.',
    formula: 'Weighted combination of cap rate, appreciation, vacancy, and economic stability',
    dataSource: 'Calculated',
    updateFrequency: 'Monthly',
    notes: 'Score from 0-100; higher indicates better investment potential',
  },
  home_value_5yr: {
    id: 'home_value_5yr',
