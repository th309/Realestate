      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex bg-surface-container p-1 rounded-xl">
            {timeframeOptions.map((opt) => (
              <button
                ...
                className={`px-3 md:px-4 py-2 text-[10px] md:text-xs font-medium rounded-lg transition-all duration-200 ${
                  timeFrame === opt
                    ? 'bg-surface text-primary elevation-1'
                    : 'text-on-surface-variant hover:text-primary'
                }`}
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-full text-[10px] font-medium border transition-all duration-200 ${
              showMilestones
          ...
          <div className="flex items-center gap-1 bg-surface-container p-1 rounded-xl border border-outline-variant">
            <button
              ...
              className={`flex items-center gap-1 px-2 py-1.5 rounded-lg text-[9px] font-medium transition-all duration-200 ${
                visibleSeries.primary
