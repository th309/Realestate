...
export const RADAR_PROFILES: Record<Exclude<RadarPreset, 'custom'>, RadarProfileConfig> = {
  homebuyer: {
    ...
    dimensions: [
      ...
      { key: 'appreciation', label: 'Price Growth', metricId: 'home_value_5yr', description: '5-year CAGR' },
      ...
      { key: 'population', label: 'Pop. Growth', metricId: 'population_growth', description: 'Year-over-year' },
  ...
  investor: {
    ...
    dimensions: [
      ...
      { key: 'appreciation', label: 'Appreciation', metricId: 'home_value_5yr', description: '5-year CAGR' },
