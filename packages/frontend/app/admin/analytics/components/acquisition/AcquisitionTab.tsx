...
export function AcquisitionTab({ days, filters }: AcquisitionTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h2 className="text-base font-medium text-on-surface">Source Attribution</h2>
        <AttributionTable data={data.sourceToConversion} />
      </div>

      {/* Row 3: Landing Page Performance */}
      <div className="space-y-3">
        <h2 className="text-base font-medium text-on-surface">Landing Page Performance</h2>
