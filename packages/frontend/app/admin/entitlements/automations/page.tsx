...
const PLANNED_TRIGGERS = [
  {
    ...
    label: "Paywall Hit",
    icon: AlertCircle,
    description: "When user hits X paywalls",
  },
  {
    type: "trial_expiring",
    label: "Trial Expiring",
    icon: Clock,
    description: "N days before trial ends",
  },
  {
    type: "inactive",
    label: "User Inactive",
    icon: Clock,
    description: "User inactive for N days",
  },
  {
    type: "tier_change",
    label: "Tier Changed",
    icon: UserPlus,
    description: "When user upgrades/downgrades",
  },
  {
    type: "signup",
    label: "User Signup",
...
const PLANNED_ACTIONS = [
  ...
  },
  {
    ...
    label: "Add Tag",
    icon: Tag,
    description: "Add user segment tag",
  },
  {
    type: "start_trial",
    label: "Start Trial",
    icon: Zap,
    description: "Auto-start trial",
  },
  {
    type: "notify_slack",
    label: "Notify Slack",
    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-on-surface-variant mb-4">
              We're building a powerful automation engine that will let you
              create rules to automatically engage users based on their
              behavior. This feature requires event processing infrastructure
      ...
      <div className="bg-surface-container rounded-xl p-6 border border-outline-variant">
        ...
        <p className="text-sm text-on-surface-variant mt-4">
          Automatically send an upgrade email and tag users who hit 5 or more
          paywalls, indicating high interest in premium features.
        </p>
      </div>
