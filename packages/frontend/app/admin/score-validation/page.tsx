          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-on-surface-variant">
                Analyzing PropertyIQ score predictive accuracy against actual
                market returns
              </p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="bg-surface-container-low border border-outline-variant rounded-xl p-4">
          ...
          <ul className="text-xs text-on-surface-variant space-y-1">
            <li>
              <strong>Correlation:</strong> Spearman rank correlation between
              score at prediction time and actual return at horizon end
            </li>
            <li>
              <strong>Hit Rate:</strong> Percentage of scores above 70 that
              outperformed their state benchmark
            </li>
            <li>
              <strong>Excess Return:</strong> Location return minus state
              benchmark return (eliminates macro effects)
            </li>
            <li>
              <strong>Quintiles:</strong> Scores divided into 5 equal groups to
              show performance spread
            </li>
            <li>
              <strong>Formula Version:</strong> Backfilled scores use current
              formulas (v3.0.0) - past scores would have been different with old
              formulas
            </li>
          </ul>
        </div>
