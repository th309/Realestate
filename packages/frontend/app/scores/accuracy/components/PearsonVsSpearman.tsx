  ...
  return (
    <section>
      ...
      <p className="text-on-surface-variant mt-2 max-w-3xl">
        The Information Coefficient (IC) &mdash; Spearman rank correlation
        &mdash; is the gold standard for evaluating predictive models.
        Here&apos;s why it matters more than Pearson.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-8">
        ...
        <div className="rounded-2xl border border-outline-variant p-5 bg-surface-container">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-on-surface">
              Pearson{" "}
              <span className="font-normal text-on-surface-variant">r</span>
            </h3>
          ...
          <div className="mt-4 bg-surface rounded-xl p-3 border border-outline-variant/50">
            <svg
              ...
              aria-label="Pearson correlation illustration: dots scattered around a fitted line"
            >
              {/* Grid */}
              <line
                x1="30"
        ...
        <div className="rounded-2xl border-2 border-primary/30 p-5 bg-primary/[0.03]">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-on-surface">
              IC / Spearman{" "}
              <span className="font-normal text-on-surface-variant">&rho;</span>
            </h3>
          ...
          <p className="text-sm text-on-surface-variant mt-3 italic">
            &quot;If I sort by score, does it match sorting by actual
            return?&quot;
          </p>
          ...
          <div className="mt-4 bg-surface rounded-xl p-3 border border-primary/20">
            <svg
              viewBox="0 0 200 120"
              className="w-full h-auto"
              aria-label="Spearman correlation illustration: dots colored by quintile showing clear rank ordering"
            >
              {/* Grid */}
              <line
                x1="30"
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-on-surface-variant mt-1 leading-relaxed">
              The <strong>Information Coefficient (IC)</strong> &mdash; the gold
              standard for evaluating predictive models in quantitative finance
              &mdash; <em>is</em> the Spearman rank correlation. Hedge funds,
              asset managers, and quant researchers all use IC (Spearman &rho;)
              to measure whether a signal correctly <em>ranks</em> outcomes from
              worst to best. Pearson measures linearity, which can be
              artificially boosted through curve-fitting. We use the same metric
              the pros use.
            </p>
