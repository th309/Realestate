        ...
        return (
          <Link key={report.id} href={`/reports/${report.id}`}>
            <M3Card
              variant="elevated"
              size="sm"
              className="relative cursor-pointer hover:elevation-3 transition-shadow"
            >
              {/* Header */}
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={`text-[9px] font-medium px-2 py-0.5 rounded-full ${status.bgColor} ${status.color}`}
                    >
                      {status.label}
                    </span>
                ...
                <div className="relative">
                  ...
                  {menuOpen === report.id && (
                    <>
                      ...
                      />
                      <div
                        className="absolute right-0 top-8 z-20 w-40 bg-surface-container-high rounded-xl elevation-2 py-1 overflow-hidden"
              ...
              {scoreValue && (
                <div className="flex items-center justify-between p-3 bg-surface-container rounded-xl mb-3">
                  ...
                  <div
                    className={`w-12 h-12 rounded-full ${scoreInfo.bgClass}/20 flex items-center justify-center`}
                  >
                    <div
                      className={`w-8 h-8 rounded-full ${scoreInfo.bgClass}/40`}
                    />
                  </div>
                </div>
              )}
