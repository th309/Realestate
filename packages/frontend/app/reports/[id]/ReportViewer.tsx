...
import {
  SectionIcon,
  formatSectionName,
} from "./components/utils/sectionDisplay";
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-[var(--report-stone)]">
                                {report.primary_geography_name} is a smaller
                                market with limited data from some sources. This
                                report uses {dc.coverage_pct}% of our standard
                                metrics
