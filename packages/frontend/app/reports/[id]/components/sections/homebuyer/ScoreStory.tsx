...
export interface ScoreStoryProps {
...
// ---------------------------------------------------------------------------
// ScoreStory Component
// ---------------------------------------------------------------------------

export function ScoreStory({ report }: ScoreStoryProps): React.ReactElement {
  const components = report.scores_snapshot?.homeready_components;
  const scoreStoryNarrative = report.ai_narrative?.score_story;
  ...
  if (!hasComponents && !hasNarrative) {
    return (
      <SectionCard title="Your Score Breakdown" icon={BarChart3}>
        <div className="flex flex-col items-center justify-center py-10">
          ...
          >
            Score component breakdown is not yet available for this report.
  ...
  return (
    <SectionCard title="Your Score Breakdown" icon={BarChart3}>
      <div className="space-y-[var(--report-space-xl)]">
        ...
        {/* ----------------------------------------------------------------- */}
        {hasComponents && (
          <div className="space-y-[var(--report-space-md)]" role="list" aria-label="Score components">
