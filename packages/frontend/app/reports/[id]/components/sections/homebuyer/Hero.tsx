...
/** Score-to-stroke-color mapping (matches ExecutiveSummary) */
...
/** Derive a letter grade from numeric score (matches ExecutiveSummary) */
...
/** Derive a human-readable label from numeric score (matches ExecutiveSummary) */
