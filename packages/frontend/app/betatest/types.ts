...
> = {
  ...
  ux_ui: { label: "UX/UI", icon: "🎨", color: "bg-indigo-100 text-indigo-800" },
  feature_request: {
...
export const STATUS_CONFIG: Record<
  FeedbackStatus,
  { label: string; color: string; testerLabel: string }
> = {
  submitted: {
    label: "Submitted",
    color: "bg-gray-100 text-gray-800",
    testerLabel: "Submitted",
  },
  triaged: {
    label: "Triaged",
    color: "bg-blue-100 text-blue-800",
    testerLabel: "Under Review",
  },
  in_progress: {
    label: "In Progress",
    color: "bg-indigo-100 text-indigo-800",
    testerLabel: "Being Worked On",
  },
  fixed: {
    label: "Fixed",
    color: "bg-green-100 text-green-800",
