...
export function MarketDeepDive({ section, report }: SectionProps) {
  ...
  const markets: MarketData[] = [
    ...
    ...comparisonGeos.map((geo) => {
      ...
      return {
        ...
        metrics: (comp?.current ?? {}) as Record<
          string,
          number | string | null
        >,
  ...
  const risksOpportunities = aiNarratives.risks_opportunities as
    | Record<
        string,
        {
          risks: string[];
                        ...
                        <div className="flex items-end justify-between">
                          ...
                          {historical && (
                            <div className="flex items-center gap-1">
                              ...
                              >
                                {historical.change_pct >= 0 ? "+" : ""}
                                {historical.change_pct.toFixed(1)}%
                              </span>
                            </div>
                          )}
                        </div>
