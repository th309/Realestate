...
// This is the heavy body of the /map route (mapbox-gl + its ~12 hooks/utils,
// plus the sidebar/toolbar/canvas UI). It's loaded via next/dynamic({ ssr:
// false }) from page.tsx so mapbox-gl never ends up in another route's
