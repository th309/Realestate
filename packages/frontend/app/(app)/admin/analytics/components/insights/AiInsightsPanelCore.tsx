...
interface AiInsightsPanelCoreProps {
  days: number;
  filters: AnalyticsFilters;
  focusArea: string;
}

export function AiInsightsPanelCore({
  days,
  focusArea,
}: AiInsightsPanelCoreProps) {
  ...
  const {
    ...
    sendFollowUp,
    reset,
  } = useAiInsights({ days, provider, focusArea: focusArea || undefined });
