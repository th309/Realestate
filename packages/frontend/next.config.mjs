    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api.mapbox.com https://www.googletagmanager.com https://www.google-analytics.com; style-src 'self' 'unsafe-inline' https://api.mapbox.com https://fonts.googleapis.com; img-src 'self' data: blob: https://maps.googleapis.com https://api.mapbox.com https://*.tiles.mapbox.com https://*.google-analytics.com https://*.supabase.co https://auth.propertyiq.app; media-src 'self' blob: https://*.supabase.co https://auth.propertyiq.app; connect-src 'self'${devConnectSrc} https://maps.googleapis.com https://api.mapbox.com https://events.mapbox.com https://*.tiles.mapbox.com https://*.railway.app https://*.supabase.co wss://*.supabase.co https://auth.propertyiq.app wss://auth.propertyiq.app https://*.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://www.google.com https://stats.g.doubleclick.net https://*.doubleclick.net https://*.ingest.sentry.io; worker-src 'self' blob:; font-src 'self' https://fonts.gstatic.com; frame-ancestors 'self'; base-uri 'self'; form-action 'self';` },
        ],
      },
      {
