-- ============================================================================
-- PROPERTYIQ - UPDATED NEWS CACHE SCHEMA FOR GEMINI
-- ============================================================================
-- Run this to update the news cache table to support the full Gemini response
-- ============================================================================
...
CREATE TABLE report_news_cache (
  ...
  -- Extracted counts for quick filtering/stats (generated columns)
...
-- Example: Schedule cleanup (run this separately or via Supabase cron)
...
-- Get all fresh cache entries
-- SELECT * FROM news_cache_summary WHERE cache_status = 'fresh';

-- Get news for a specific geography
-- SELECT * FROM get_news_cache_status('phoenix-mesa-az', 'metro');

-- Get geographies with bullish signals
-- SELECT geography_name, overall_signal, local_news_count 
-- FROM report_news_cache 
-- WHERE overall_signal = 'bullish' AND expires_at > NOW();

-- Extract high-relevance local news items
-- SELECT 
--   geography_name,
--   news_item->>'headline' AS headline,
--   news_item->>'impact_on_real_estate' AS impact
-- FROM report_news_cache,
--      jsonb_array_elements(news_data->'local_news') AS news_item
-- WHERE news_item->>'relevance' = 'high'
--   AND expires_at > NOW();
