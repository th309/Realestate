# All Available Zillow Datasets

This document lists all datasets available on the Zillow Research Data page that we should consider importing.

## Currently Imported (US/National + Metro)

### HOME VALUES
- ✅ ZHVI All Homes (SFR, Condo/Co-op) - Smoothed, Seasonally Adjusted

### RENTALS
- ✅ ZORI (Smoothed) - All Homes Plus Multifamily

### FOR-SALE LISTINGS
- ✅ For-Sale Inventory (Smooth, All Homes, Monthly)

### SALES
- ✅ Sales Count (Nowcast, All Homes, Monthly)
- ✅ Median Sale Price (Nowcast, All Homes, Monthly)

### DAYS ON MARKET
- ✅ Mean Days to Pending (Smooth, All Homes, Monthly)

### MARKET HEAT INDEX
- ✅ Market Heat Index (All Homes, Monthly)
...
### AFFORDABILITY
- ✅ New Homeowner Income Needed (20% down)
- ✅ New Renter Income Needed
- ✅ Affordable Home Price (20% down)
- ✅ Years to Save (20% down)
- ✅ New Homeowner Affordability (20% down)
- ✅ New Renter Affordability

## Missing Datasets to Add

### HOME VALUES - Additional Options
- [ ] ZHVI All Homes - Raw, Mid-Tier
- [ ] ZHVI All Homes - Top Tier
- [ ] ZHVI All Homes - Bottom Tier
- [ ] ZHVI Single-Family Homes Only
- [ ] ZHVI Condo/Co-op Only
- [ ] ZHVI 1-Bedroom
- [ ] ZHVI 2-Bedroom
- [ ] ZHVI 3-Bedroom
- [ ] ZHVI 4-Bedroom
- [ ] ZHVI 5+ Bedroom
- [ ] Mortgage Payment (20%, 10%, 5% down)
- [ ] Total Monthly Payment (20%, 10%, 5% down)

### HOME VALUES FORECASTS
- [ ] ZHVF (Forecast) - Smoothed, Seasonally Adjusted, Mid-Tier
- [ ] ZHVF (Forecast) - Raw, Mid-Tier

### RENTALS - Additional Options
- [ ] ZORI (Smoothed, Seasonally Adjusted) - All Homes Plus Multifamily
- [ ] ZORI (Smoothed) - Single Family Residence
- [ ] ZORI (Smoothed, Seasonally Adjusted) - Single Family Residence
- [ ] ZORI (Smoothed) - Multi Family Residence
- [ ] ZORI (Smoothed, Seasonally Adjusted) - Multi Family Residence
- [ ] ZORDI - All Homes Plus Multifamily
- [ ] ZORDI - Single Family Residence
- [ ] ZORDI - Condo/Co-op

### RENTAL FORECASTS
- [ ] ZORF (Forecast) - Single Family Residence, Smoothed
- [ ] ZORF (Forecast) - Multi Family Residence, Smoothed

### FOR-SALE LISTINGS - Additional Options
...
- [ ] New Listings (Smooth, All Homes, Monthly)
...
- [ ] Mean Sale Price (Nowcast, All Homes, Monthly)
...
- [ ] Total Transaction Value (Nowcast, All Homes, Monthly)
...
### DAYS ON MARKET AND PRICE CUTS - Additional Options
...
### NEW CONSTRUCTION - Additional Options
...
For US/National and Metro level data, I recommend adding these high-priority datasets:

1. **New Listings** - Important for understanding market activity
2. **Median List Price** - Key pricing metric
3. **Mean Sale Price** - Complements median sale price
4. **Sale-to-List Ratio** - Important market indicator
5. **Percent Above/Below List** - Market competitiveness indicator
6. **Days to Close** - Complements days to pending
7. **Price Cuts** - Market condition indicator
